...
#include <memory>
#include "../COMP3004DenasProject/treatment.h"
...
QT_MOC_LITERAL(1, 10, 14), // "updateGUITimer"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 17), // "sendBatteryUpdate"
QT_MOC_LITERAL(4, 44, 14) // "decrementTimer"

    },
    "Treatment\0updateGUITimer\0\0sendBatteryUpdate\0"
    "decrementTimer"
};
...
void Treatment::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateGUITimer((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->sendBatteryUpdate((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->decrementTimer(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Treatment::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Treatment::updateGUITimer)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Treatment::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Treatment::sendBatteryUpdate)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Treatment::updateGUITimer(QString _t1)
{
...
// SIGNAL 1
void Treatment::sendBatteryUpdate(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
